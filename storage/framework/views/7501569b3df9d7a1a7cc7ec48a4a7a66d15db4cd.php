        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-4 p-b-30">
                <form action="<?php echo e(url('user/signup')); ?>" method="POST">
                    ...
                    <div class="bo4 of-hidden size15 m-b-20">
                        <input class="sizefull s-text7 p-l-22 p-r-22" type="password" name="password_confirmation" placeholder="Confirm Password" required>
                    </div>

                    <div class="w-size19 float-right mt-2">
                        <!-- Button -->
                        <input class="flex-c-m size2 bg1 bo-rad-23 hov1 m-text3 trans-0-4" type="submit" name="submit" value="Sign Up">
                    </div>
                </form> 

                <p class="s-text7 w-size27 mt-4">Have an account? <a href="<?php echo e(url('user/signin')); ?>">Sign In</a></p>
            </div>
        </div>
    </div>
</section>
