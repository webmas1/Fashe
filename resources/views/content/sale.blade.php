        ...
        <div class="row">
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
                <div class="leftbar p-r-20 p-r-0-sm">
                    ...
                    <ul class="p-b-54">
                        <li class="p-t-4">
                            <a href="{{url('#')}}" class="s-text13 active1">
                                All
                            </a>
                        </li>

                        <li class="p-t-4">
                            <a href="{{url('#')}}" class="s-text13">
                                Women
                            </a>
                        </li>
            ...
            <div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
                        ...
                        <div class="block2">
                            <div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelsale">
                                <img src="{{url('images/item-07.jpg')}}" alt="IMG-PRODUCT">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
                        ...
                        <div class="block2">
                            <div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
                                <img src="{{url('images/item-01.jpg')}}" alt="IMG-PRODUCT">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
                        ...
                        <div class="block2">
                            <div class="block2-img wrap-pic-w of-hidden pos-relative">
                                <img src="{{url('images/item-14.jpg')}}" alt="IMG-PRODUCT">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
                        ...
                        <div class="block2">
                            <div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
                                <img src="{{url('images/item-06.jpg')}}" alt="IMG-PRODUCT">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
                        ...
                        <div class="block2">
                            <div class="block2-img wrap-pic-w of-hidden pos-relative">
                                <img src="{{url('images/item-10.jpg')}}" alt="IMG-PRODUCT">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
                        ...
                        <div class="block2">
                            <div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelsale">
                                <img src="{{url('images/item-11.jpg')}}" alt="IMG-PRODUCT">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
                        ...
                        <div class="block2">
                            <div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
                                <img src="{{url('images/item-12.jpg')}}" alt="IMG-PRODUCT">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
                        ...
                        <div class="block2">
                            <div class="block2-img wrap-pic-w of-hidden pos-relative">
                                <img src="{{url('images/item-15.jpg')}}" alt="IMG-PRODUCT">
